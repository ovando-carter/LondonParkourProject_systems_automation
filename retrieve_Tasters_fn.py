...
#select the new database file you would like to add to the database
database_file = 'londonParkourProject.db'

sqlite_code = "select distinct Date, count(Date) from Orders where Event_Name like '%TRIAL%' or Event_Name like '%TASTER%' group by Date order by Date"
